...
Modified paths for Docker container execution
"""
...
LOGO_PATH = "/tmp/cropped-Logo-INFO-FOND-BLANC.jpg"
OUTPUT_PATH = "/tmp/IAM_Gateway_UPEC.pptx"
...
def create_presentation():
    ...
    # Slide 9: Dashboard
    dashboard_img = os.path.join(SCREENSHOTS_PATH, "dashboard.png")
    ...
    ldap_img = os.path.join(SCREENSHOTS_PATH, "ldap-groups.png")
    ...
    comparison_img = os.path.join(SCREENSHOTS_PATH, "comparaison-live.png")
